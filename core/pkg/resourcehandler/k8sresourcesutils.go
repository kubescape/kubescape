...
func isEmptyImgVulns(armoResourcesMap cautils.KSResources) bool {
...
func setArmoResourceMap(frameworks []reporthandling.Framework, resourceToControl map[string][]string) *cautils.KSResources {
	armoResources := make(cautils.KSResources)
