...
func (prettyPrinter *PrettyPrinter) resourceTable(opaSessionObj *cautils.OPASessionObj) {
	...
	for resourceID, result := range opaSessionObj.ResourcesResult {
		...
		resourceRows := generateResourceRows(result.ListControls(), &opaSessionObj.Report.SummaryDetails)
...
func generateResourceRows(controls []resourcesresults.ResourceAssociatedControl, summaryDetails *reportsummary.SummaryDetails) []table.Row {
	var rows []table.Row
