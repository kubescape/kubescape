...
require (
	...
	github.com/aquasecurity/trivy v0.44.0 // indirect
...
replace github.com/project-copacetic/copacetic => github.com/anubhav06/copacetic v0.0.0-20230803114228-3878d962c524
