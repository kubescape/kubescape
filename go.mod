...
require (
	...
	github.com/kubescape/k8s-interface v0.0.95
...
require (
	...
	github.com/awslabs/amazon-ecr-credential-helper/ecr-login v0.0.0-30220228164355-396b2034c795 // indirect
	github.com/benbjohnson/clock v1.1.5 // indirect
